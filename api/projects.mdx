...
description: "REST endpoints to list, create, update, and delete Superlog projects. Automate project provisioning with the management API."
---
...
```json
{
  ...
  "api_key": {
    ...
    "key_prefix": "sl_live_xx",
    "plaintext": "sl_live_xxxxxxxxxxxxxxxxxxxx"
  }
}
```
