...
| Ingest key | `sl_live_…` | Single project | OTLP data ingest (`/v1/traces`, `/v1/logs`, `/v1/metrics`) |
...
<CardGroup cols={2}>
  <Card title="Projects" icon="folder" href="/api/projects">
    List, create, update, and delete projects in your org.
  </Card>
  <Card title="API Keys" icon="key" href="/api/api-keys">
    Mint and revoke project-scoped ingest keys programmatically.
  </Card>
  ...
  <Card title="MCP Server" icon="robot" href="/api/mcp-tools">
