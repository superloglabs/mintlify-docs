---
title: "Configure AI Agent PR Automation in Superlog"
sidebarTitle: "Agent Settings"
description: "Control how Superlog's AI agent opens and merges fix PRs. Set auto-merge policy, merge strategy, and target branch per project."
---
...
Set `pr_base_branch` to `null` or an empty string to revert to the repository's default branch.
