---
title: "GitHub Integration: Automated Fix PRs with Superlog"
sidebarTitle: "GitHub"
description: "Connect your GitHub repositories to Superlog so the AI agent can read source code, open fix PRs, and auto-merge when CI checks pass."
---
