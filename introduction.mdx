...
description: "Superlog is an open-source agentic telemetry system: ingest OTLP data, group errors into incidents, and fix them with AI agents automatically."
---
